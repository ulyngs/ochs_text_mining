...
mahabharatha_cleaned %>% 
  write_csv(str_c(processed_path, today(), "_mahabharatha_cleaned.csv"))

ramayana_cleaned %>% 
  write_csv(str_c(processed_path, today(), "_ramayana_cleaned.csv"))

rgveda_cleaned %>% 
  write_csv(str_c(processed_path, today(), "_rgveda_cleaned.csv"))
